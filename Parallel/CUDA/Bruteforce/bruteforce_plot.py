...
data = pd.read_csv('tsp_cuda_bruteforce.csv')
...
plt.title('CUDA_Bruteforce vs Serial Bruteforce Execution Time Comparison')
...
# Show the plot
plt.savefig("CUDA_Brute_vs_Serial_Brute.png")
